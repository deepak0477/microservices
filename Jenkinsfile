                        ...
                        script{
                            dir('wishlist-microservice-python') {
                                ...
                                withSonarQubeEnv('sonar-pro') {
                                    ...
                                    -D sonar.host.url=http://65.2.144.49:9000/"""
                                }
                            }
                        }
                    }
            ...
            steps {
                parallel (
                    ...
                    'ui-web-app-reactjs': {
                        dir('ui-web-app-reactjs'){
                            sh """
                            docker build -t vignesh1592/ui:v1 .
                            docker push vignesh1592/ui:v1
                            docker rmi vignesh1592/ui:v1
                            """
                        }
                    },
                    'zuul-api-gateway' : {
                        dir('zuul-api-gateway'){
                            sh """
                            docker build -t vignesh1592/api:v1 .
                            docker push vignesh1592/api:v1
                            docker rmi vignesh1592/api:v1
                            """
                        }
                    },
                    'offers-microservice-spring-boot': {
                        dir('offers-microservice-spring-boot'){
                            sh """
                            docker build -t vignesh1592/spring:v1 .
                            docker push vignesh1592/spring:v1
                            docker rmi vignesh1592/spring:v1
                            """
                        }
                    },
                    'shoes-microservice-spring-boot': {
                        dir('shoes-microservice-spring-boot'){
                            sh """
                            docker build -t vignesh1592/spring:v2 .
                            docker push vignesh1592/spring:v2
                            docker rmi vignesh1592/spring:v2
                            """
                        }
                    },
                    'cart-microservice-nodejs': {
                        dir('cart-microservice-nodejs'){
                            sh """
                            docker build -t vignesh1592/ui:v2 .
                            docker push vignesh1592/ui:v2
                            docker rmi vignesh1592/ui:v2
                            """
                        }
                    },
                    'wishlist-microservice-python': {
                        dir('wishlist-microservice-python'){
                            sh """
                            docker build -t vignesh1592/python:v1 .
                            docker push vignesh1592/python:v1
                            docker rmi vignesh1592/python:v1
                            """
                        }
                    }
                )
